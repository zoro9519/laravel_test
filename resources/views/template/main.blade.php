    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="/dashboard" class="brand-link">
                ...
                <span class="brand-text font-weight-light">L & B M S</span>
            </a>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        @if(!(Auth::check() || (Auth::user() && Auth::user()->role == 0)))
                            <li class="nav-item">
        ...
        <footer class="main-footer">
            ...
            <!-- Default to the left -->
            <strong>Copyright &copy; 2024 Library And Book Management System.</strong> All rights
            reserved.
        </footer>
    </div>
    <!-- ./wrapper -->
